...
*/
var g_asDobjEntitySelectorCookieName = "dobjEntitySelector";
var g_asDobjTemplateSelectorCookieName = "dobjTemplateSelector";
function resumeDobjEntitySelector(){
	var sSetting = getCookie(g_asDobjEntitySelectorCookieName);
	setSelectValue("selDobjEntity", sSetting);
}
function resumeDobjTemplateSelector(){
	var sSetting = getCookie(g_asDobjTemplateSelectorCookieName);
	setSelectValue("selDobjTemplate", sSetting);
}
