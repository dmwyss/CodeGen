...
//name="txtDobj_setting_intAsInteger" onchange="doOnChangeSelectedDobjSetting()"
...
function doOnChangeSelectedDobj(){
	/*
	var sOffOn = "";
...
function doOnChangeSelectedDobjSetting(){
	/*
	var sOffOn = "";
...
function resumeSelectedDobjSetting(){
	/*
